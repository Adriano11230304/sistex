...
export default function AddReceitasIcons({ navigation, route }) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <TouchableOpacity style={styles.salvarManualmente} onPress={() => {navigation.navigate("AddReceita")}}><Text style={styles.salvarText}>Adicionar uma receita manualmente</Text></TouchableOpacity>
        </SafeAreaView>
    );
}