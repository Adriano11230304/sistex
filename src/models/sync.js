...
db.transaction((tx) => {
    ...
    tx.executeSql(
        "CREATE TABLE IF NOT EXISTS pagar (id INTEGER PRIMARY KEY AUTOINCREMENT, valor FLOAT, observacoes TEXT, parcelas INTEGER, fixa BOOLEAN, categoria TEXT, fornecedor_id INTEGER, created_at TEXT, data_entrada TEXT, pago BOOLEAN, data_pagamento TEXT, FOREIGN KEY(fornecedor_id) REFERENCES fornecedores(id));"
    );
